        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    ...
                    <h3 class="brand-name"><b class="text-warning">Zato</b>Ku</h3>
                </div>
                ...
                <div class="col-md-5 my-auto">
                    <ul class="nav justify-content-end">
                        ...
                        @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}"> <i class="fa fa-sign-in"></i> {{ __('Masuk') }}</a>
                        </li>
                        @endif
                        @else
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand d-block d-sm-block d-md-none d-lg-none" href="{{ url('/') }}">
                <h5 class="mx-2 my-auto"><b class="text-warning">Zato</b>Ku</h5>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url ('/new-arrival') }}">Produk Baru</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url ('/featured-product') }}">Produk Unggulan</a>
                    </li>
                    <li class="nav-item">
