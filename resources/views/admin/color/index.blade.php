    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4><U> Color List </U>
                    <a href="{{url('admin/color/create')}}" class="btn btn-warning btn-sm float-end">+ Add Product</a>
                </h4>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('admin/color/'.$item->id)}}" class="btn btn-sm btn-outline-success">
                                ...
                                <a href="{{url('admin/color/'.$item->id.'/delete')}}" onclick="return confirm('Are you sure delete Color?')" class="btn btn-sm btn-outline-danger">
