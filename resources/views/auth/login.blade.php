            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end"><i class="fa fa-lg fa-lock"></i></label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4 float-end">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Masuk') }}
                                </button>
                               <a href="{{url('register')}}" class="btn btn-primary">Registrasi</a>
