            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end"><i class="fa fa-user fa-lg"></i></label>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end"><i class="fa fa-envelope "></i></label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end"><i class="fa fa-lock fa-lg"></i></label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end"> <i class="fa fa-lock fa-lg"></i> </label>
